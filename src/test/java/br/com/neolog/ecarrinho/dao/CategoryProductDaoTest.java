...
public class CategoryProductDaoTest {
	...
	public void productPersistence()
	{
		...
		Assert.assertEquals(categoryDao.get(CATEGORY_1.getName()).toString(), CATEGORY_1.toString());
		Assert.assertEquals(productDao.get(PRODUCT_4.getId()).toString(), PRODUCT_4.toString());
	}
}
