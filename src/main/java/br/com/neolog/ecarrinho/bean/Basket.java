...
/**
 * The Class Basket.
 * This class represents a collection of products that the user of the system selects for buying.
 *
...
public class Basket implements Persistable {
	...
	/** The products.
	 * 	This map contains what products are going to be bought and their respective amount;.
	*/
	@ElementCollection
	 ...
	 * @param amount the amount of the product. If the product is already in the basket, its previous amount is add to this new
	 */
