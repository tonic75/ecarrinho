...
/**
 * The Class UserOrder.
 * This class represents a order that a user do. It contains all the information necessary for it:
 *  - The basket with the products and the amounts.
 *  - When the order was made.
 *  - The user that did it.
 *  - The address to shipment.
 *  - The card for payment.
 *  - The agency number for debt.
 *  - The account number for debt.
...
public class UserOrder implements Persistable{
	...
	public boolean equals(Object obj) {
		...
		return Objects.equal(this.basket, userOrder.basket)
				&& Objects.equal(this.user, userOrder.user)
