...
public class ProductService
{
	...
	public List<Product> getProductsByCategory( String categoryName )
	{
		...
		return (List<Product>) productsByCategoryCache.get( categoryDao.get( categoryName ) );
	}

	/**
	 * Gets the all products by category.
	 * 
	 * @return a map with category as key and the respectives products as
	 *         values.
	 */
	 ...
	 * @param description
	 *            the description
	 * @return a list with all the products found having the passed description
	 *         included into theirs.
	 */
