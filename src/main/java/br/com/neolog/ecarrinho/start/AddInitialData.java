...
public class AddInitialData
{
	...
	public void productPersistence()
	{
		...
		Product CD_SONY = new Product( Automotivo, "CD Player Sony", 329.00, "cdsony.jpg" );
		productDao.save( CD_SONY );
		...
		acquisitionService.addAcquisition( new Acquisition( CD_SONY, 20L ) );
		acquisitionService.addAcquisition( new Acquisition( CD_SONY, 5L ) );
	}
}