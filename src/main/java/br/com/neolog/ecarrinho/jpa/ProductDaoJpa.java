 ...
 * 
 *         The final DAO for Product. Passes his type for GenericDaoJpa
 *         constructor.
 */
@Component
public class ProductDaoJpa extends GenericDaoJpa<Product, Long> implements ProductDao
{
	 ...
	 * 
	 * @see
	 * br.com.neolog.ecarrinho.dao.ProductDao#getProductsByCategory(br.com.neolog
	 * .ecarrinho.bean.Category)
	 */
	 ...
	 * 
	 * @see
	 * br.com.neolog.ecarrinho.dao.ProductDao#getProductsByDescription(java.
	 * lang.String)
	 */
	@SuppressWarnings( "unchecked" )
